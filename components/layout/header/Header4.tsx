                    ...
                    <div className="main-header-style4__content-inner">
                        <div className="main-header-style4__content-left">
                            <div className="header-logo-box-style4">
                                <Link href="/index-4">
<Image src="https://res.cloudinary.com/drgk8rmny/image/upload/v1788390625/ChatGPT_Image_Sep_3__2026__12_05_11_AM-removebg-preview_qs5iis.png" alt="Lucid Global Invest logo" width={189} height={26} priority />
                                </Link>
                            </div>
