...
export default function Blog_Details() {
    ...
    return (
      ...
      <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Blog" breadcrumbTitleTwo="Blog">
                        ...
                        <div className="col-xl-8">
                            ...
                            <div className="blog-details-top">
                                <div className="content-box">
                                    ...
                                    <div className="title-box">
                                        <h3>
                                            Effect of Fiscal Policies on Stock Market Performance
                                        </h3>
                                    </div>
                                </div>
                                <div className="img-box">
                                    <Image src="/assets/images/blog/blog-v5-2.jpg" alt="Image" width={770} height={500} priority />
                                </div>
                            </div>
                            ...
                            <div className="blog-details-quote">
                                ...
                                <div className="words-by">
                                    <p><span>Silver Scott</span> Market Analyst.</p>
                                </div>
