...
// ✅ Server component
export default async function BlogSinglePage_Three({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
<Layout headerStyle={1} footerStyle={1} breadcrumbTitle={post.title} breadcrumbTitleTwo="Blog">
