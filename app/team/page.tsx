                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-v1-4.jpg" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>6+ years of experience in markets.</h6>
                                            <Link href="#">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-v1-5.jpg" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>8+ years of experience in markets.</h6>
                                            <Link href="#">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-v1-6.jpg" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>5+ years of experience in markets.</h6>
                                            <Link href="#">
